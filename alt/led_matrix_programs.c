...
void *led_setups[] = {leds_rainbow_s, leds_rainbow_ns,leds_cyan_with_salmon_stripe, leds_teal_salmon, leds_yellow, leds_red, leds_green, leds_blue, leds_white, leds_white_with_red_stripe, leds_black_with_red_stripe, leds_off};
